...
$(document)
    .ready(function() {
        ...
        $(".subnav-menu > li > a[data-toggle=dropdown]")
            .click(function() {
                    ...
                    setTimeout(function() {
                            ...
                            $parent.prev()
                                .slideUp(200,
                                    function() {
                                        $parent.prev().remove();
                                        $el.removeClass("update-input btn-satgreen")
                                            .addClass("btn-grey-4 change-input")
                                            .text("Change");
                                    });
                        },
                        1000);
        ...
        $(".content-remove")
            .click(function(e) {
                ...
                bootbox.confirm("Do you really want to remove the widget <strong>" +
                    $el.parents(".box-title").find("h3").text() +
                    "</strong>?",
                    "Cancel",
                    "Yes, remove",
                    function(r) {
                        if (r) {
                            ...
                            if (previousElement.length > 0) {
                                previousElement.removeClass("span" + prevSpanWidth)
                                    .addClass("span" + (prevSpanWidth + spanWidth));
                            }
                        }
                    });
            });
        ...
        $(".toggle-subnav")
            .click(function(e) {
                ...
                var $el = $(this);
                $el.parents(".subnav")
                    .toggleClass("subnav-hidden")
                    .find(".subnav-menu, .subnav-content")
                    .slideToggle("fast");
...
// set resize handler to corret height
        ...
        $(".table .alpha")
            .click(function(e) {
                ...
                $(".letterbox .letter > .active")
                    .click(function() {
                        var $el = $(this);
                        if ($el.text() != "All") {
                            slimScrollUpdate($el.parents(".scrollable"), 0);
                            var scrollToElement = $el.parents(".box-content")
                                .find(".table .alpha:contains('" + $el.text() + "')");
