...
(function($) {
    ...
    $.fn.columnFilter = function(options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            var sFromId = oTable.attr("id") + "_range_from_" + i;
            var from =
                $('<input type="text" placeholder="From" class="date_range_filter" style="margin-bottom:2px;" id="' +
                    sFromId +
                    '" rel="' +
                    i +
                    '"/>');
            ...
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + "_range_to_" + i;
            var to = $('<input type="text" placeholder="To" class="date_range_filter" id="' +
                sToId +
                '" rel="' +
                i +
                '"/>');
...
//Issue 37
        ...
        function fnCreateCheckbox(oTable, aData) {
            ...
            r += '<button id="' + buttonId + '" class="checkbox_filter" > ' + labelBtn + "</button>";
//filter button witch open dialog
        ...
        return this.each(function() {
            ...
            $(aoFilterCells)
                .each(function(index) { //fix for ColVis
                    i = index;
                    var aoColumn = {
                        type: "text",
                        bRegex: false,
