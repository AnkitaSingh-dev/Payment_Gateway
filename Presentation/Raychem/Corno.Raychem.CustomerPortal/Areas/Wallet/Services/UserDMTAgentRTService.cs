...
{
    public class UserDMTAgentRTService : BaseService<UserDMTAgentRT>, IUserDMTAgentRTService
    {
        #region -- Constructors --
        public UserDMTAgentRTService(IUnitOfWork unitOfWork, IGenericRepository<UserDMTAgentRT> repository)
