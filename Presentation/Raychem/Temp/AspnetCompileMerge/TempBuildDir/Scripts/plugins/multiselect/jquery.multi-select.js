    ...
    MultiSelect.prototype = {
        ...
        init: function() {
            ...
            if (ms.next(".ms-container").length == 0) {
                    ...
                    .each(function() {
                        if ($(this).is("optgroup")) {
                            ...
                            if (that.options.selectableOptgroup) {
                                ...
                                optgroupSelectionLi.on("click",
                                    function() {
                                        var values = optgroup.children(":selected")
                                            .map(function() { return $(this).val() })
                                            .get();
                            ...
                            if (optgroupId) {
                                that.$selectableUl.children("#" + optgroupId + "-selectable")
                                    .find("ul")
                                    .first()
                                    .append(selectableLi);
                                that.$selectionUl.children("#" + optgroupId + "-selection")
                                    .find("ul")
                                    .first()
                                    .append(selectedLi);
                            } else {
                ...
                that.$selectableUl.on("mouseenter",
                        ".ms-elem-selectable",
                        function() {
                ...
                if (that.options.dblClick) {
                    that.$selectableUl.on("dblclick",
                        ".ms-elem-selectable",
                        function() {
                            that.select($(this).data("ms-value"));
                        });
                    that.$selectionUl.on("dblclick",
                        ".ms-elem-selection",
                        function() {
                            that.deselect($(this).data("ms-value"));
                        });
                } else {
                    that.$selectableUl.on("click",
                        ".ms-elem-selectable",
                        function() {
                            that.select($(this).data("ms-value"));
                        });
                    that.$selectionUl.on("click",
                        ".ms-elem-selection",
                        function() {
                            that.deselect($(this).data("ms-value"));
                        });
                ...
                that.$selectionUl.on("mouseenter",
                        ".ms-elem-selection",
                        function() {
                ...
                ms.on("keydown",
                    function(e) {
                        if (ms.is(":focus")) {
                            var keyContainer = that.$selectableUl.hasClass("ms-focus")
                                ? "ms-selectable"
                                : "ms-selection";
