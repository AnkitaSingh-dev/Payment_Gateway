...
CKEDITOR.lang["ku"] = {
    ...
    "bidi": { "ltr": "ئاراستهی نووسه لهچهپ بۆ ڕاست", "rtl": "ئاراستهی نووسه لهڕاست بۆ چهپ" },
    ...
    "colorbutton": {
        ...
        "colors": { "000": "ڕهش", "800000": "سۆرو ماڕوونی", "8B4513": "ماڕوونی", "2F4F4F": "سهوزی تاریك", "008080": "سهوزو شین", "000080": "شینی تۆخ", "4B0082": "مۆری تۆخ", "696969": "ڕهساسی تۆخ", "B22222": "سۆری تۆخ", "A52A2A": "قاوهیی", "DAA520": "قاوهیی بریسکهدار", "006400": "سهوزی تۆخ", "40E0D0": "شینی ناتۆخی بریسکهدار", "0000CD": "شینی مامناوهند", "800080": "پهمبهیی", "808080": "ڕهساسی", "F00": "سۆر", "FF8C00": "نارهنجی تۆخ", "FFD700": "زهرد", "008000": "سهوز", "0FF": "شینی ئاسمانی", "00F": "شین", "EE82EE": "پهمهیی", "A9A9A9": "ڕهساسی ناتۆخ", "FFA07A": "نارهنجی ناتۆخ", "FFA500": "نارهنجی", "FFFF00": "زهرد", "00FF00": "سهوز", "AFEEEE": "شینی ناتۆخ", "ADD8E6": "شینی زۆر ناتۆخ", "DDA0DD": "پهمهیی ناتۆخ", "D3D3D3": "ڕهساسی بریسکهدار", "FFF0F5": "جهرگی زۆر ناتۆخ", "FAEBD7": "جهرگی ناتۆخ", "FFFFE0": "سپی ناتۆخ", "F0FFF0": "ههنگوینی ناتۆخ", "F0FFFF": "شینێکی زۆر ناتۆخ", "F0F8FF": "شینێکی ئاسمانی زۆر ناتۆخ", "E6E6FA": "شیری", "FFF": "سپی" },
        "more": "ڕهنگی زیاتر...",
        "panelTitle": "ڕهنگهکان",
    ...
    "toolbar": {
        ...
        "toolbarGroups": { "document": "پهڕه", "clipboard": "بڕین/پووچکردنهوه", "editing": "چاکسازی", "forms": "داڕشته", "basicstyles": "شێوازی بنچینهیی", "paragraph": "بڕگه", "links": "بهستهر", "insert": "خستنه ناو", "styles": "شێواز", "colors": "ڕهنگهکان", "tools": "ئامرازهکان" },
    ...
    "font": {
        "fontSize": { "label": "گهورهیی", "voiceLabel": "گهورهیی فۆنت", "panelTitle": "گهورهیی فۆنت" },
        "label": "فۆنت",
    ...
    "forms": {
        ...
        "checkboxAndRadio": { "checkboxTitle": "خاسیهتی چووارگۆشی پشکنین", "radioTitle": "خاسیهتی جێگرهوهی دوگمه", "value": "نرخ", "selected": "ههڵبژاردرا" },
        "form": { "title": "خاسیهتی داڕشته", "menu": "خاسیهتی داڕشته", "action": "کردار", "method": "ڕێگه", "encoding": "بهکۆدکهر" },
        "hidden": { "title": "خاسیهتی خانهی شاردراوه", "name": "ناو", "value": "نرخ" },
        "select": { "title": "ههڵبژاردهی خاسیهتی خانه", "selectInfo": "زانیاری", "opAvail": "ههڵبژاردهی ههبوو", "value": "نرخ", "size": "گهورهیی", "lines": "هێڵهکان", "chkMulti": "ڕێدان بهفره ههڵبژارده", "opText": "دهق", "opValue": "نرخ", "btnAdd": "زیادکردن", "btnModify": "گۆڕانکاری", "btnUp": "سهرهوه", "btnDown": "خوارهوه", "btnSetValue": "دابنێ وهك نرخێکی ههڵبژێردراو", "btnDelete": "سڕینهوه" },
        "textarea": { "title": "خاسیهتی ڕووبهری دهق", "cols": "ئهستونیهکان", "rows": "ڕیزهکان" },
        "textfield": { "title": "خاسیهتی خانهی دهق", "name": "ناو", "value": "نرخ", "charWidth": "پانی نووسه", "maxChars": "ئهوپهڕی نووسه", "type": "جۆر", "typeText": "دهق", "typePass": "پێپهڕهوشه", "typeEmail": "Email", "typeSearch": "Search", "typeTel": "Telephone Number", "typeUrl": "URL" }
    },
    "format": {
        "label": "ڕازاندنهوه",
    ...
    "smiley": { "options": "ههڵبژاردهی زهردهخهنه", "title": "دانانی زهردهخهنهیهك", "toolbar": "زهردهخهنه" },
    "justify": { "block": "هاوستوونی", "center": "ناوهڕاست", "left": "بههێڵ کردنی چهپ", "right": "بههێڵ کردنی ڕاست" },
    "link": {
        "acccessKey": "کلیلی دهستپێگهیشتن",
        "advanced": "پێشکهوتوو",
        "advisoryContentType": "جۆری ناوهڕۆکی ڕاویژکار",
        "advisoryTitle": "ڕاوێژکاری سهردێڕ",
        "anchor": { "toolbar": "دانان/چاکسازی لهنگهر", "menu": "چاکسازی لهنگهر", "title": "خاسیهتی لهنگهر", "name": "ناوی لهنگهر", "errorName": "تکایه ناوی لهنگهر بنووسه", "remove": "لابردنی لهنگهر" },
    ...
    "selectall": { "toolbar": "نیشانکردنی هەمووی" },
    ...
    "table": {
        ...
        "caption": "سهردێڕ",
        "cell": { "menu": "خانه", "insertBefore": "دانانی خانه لهپێش", "insertAfter": "دانانی خانه لهپاش", "deleteCell": "سڕینهوهی خانه", "merge": "تێکهڵکردنی خانه", "mergeRight": "تێکهڵکردنی لهگهڵ ڕاست", "mergeDown": "تێکهڵکردنی لهگهڵ خوارهوه", "splitHorizontal": "دابهشکردنی خانهی ئاسۆیی", "splitVertical": "دابهشکردنی خانهی ئهستونی", "title": "خاسیهتی خانه", "cellType": "جۆری خانه", "rowSpan": "ماوهی نێوان ڕیز", "colSpan": "بستی ئهستونی", "wordWrap": "پێچانهوهی وشه", "hAlign": "ڕیزکردنی ئاسۆیی", "vAlign": "ڕیزکردنی ئهستونی", "alignBaseline": "هێڵهبنهڕهت", "bgColor": "ڕهنگی پاشبنهما", "borderColor": "ڕهنگی پهراوێز", "data": "داتا", "header": "سهرپهڕه", "yes": "بهڵێ", "no": "نهخێر", "invalidWidth": "پانی خانه دهبێت بهتهواوی ژماره بێت.", "invalidHeight": "درێژی خانه بهتهواوی دهبێت ژماره بێت.", "invalidRowSpan": "ماوهی نێوان ڕیز بهتهواوی دهبێت ژماره بێت.", "invalidColSpan": "ماوهی نێوان ئهستونی بهتهواوی دهبێت ژماره بێت.", "chooseColor": "ههڵبژاردن" },
        "cellPad": "بۆشایی ناوپۆش",
        "cellSpace": "بۆشایی خانه",
        "column": { "menu": "ئهستون", "insertBefore": "دانانی ئهستون لهپێش", "insertAfter": "دانانی ئهستوون لهپاش", "deleteColumn": "سڕینهوهی ئهستوون" },
        "columns": "ستوونهکان",
        ...
        "menu": "خاسیهتی خشته",
        "row": { "menu": "ڕیز", "insertBefore": "دانانی ڕیز لهپێش", "insertAfter": "دانانی ڕیز لهپاش", "deleteRow": "سڕینهوهی ڕیز" },
        "rows": "ڕیز",
        "summary": "کورته",
        "title": "خاسیهتی خشته",
        "toolbar": "خشته",
