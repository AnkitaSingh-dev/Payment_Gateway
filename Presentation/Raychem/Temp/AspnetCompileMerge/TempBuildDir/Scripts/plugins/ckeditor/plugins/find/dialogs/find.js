                        ...
                        for (b = null;
                            !b &&
                                !(b = this._.walker[a ? "previous" : "next"]
                                    .call(this._.walker), this._.matchWord && !b || this._.walker._.end);
                        );
            ...
            r.prototype = {
                toDomRange: function() {
                    ...
                    if (1 > b.length) {
                        ...
                        d = b[0], b = b[b.length - 1], a.setStart(d.textNode, d.offset), a
                            .setEnd(b.textNode, b.offset + 1);
                    return a
                },
            ...
            var z = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/,
                ...
                e = {
                    ...
                    find: function(a, b, d, f, e, A) {
                        ...
                        return f && !A
                            ? (this.searchRange = q(1), this.matchRange = null, arguments.callee
                                .apply(this, Array.prototype.slice.call(arguments).concat([!0])))
                            : !1
                    },
                    replaceCounter: 0,
            ...
            return{
                        ...
                        elements: [
                            {
                                ...
                                children: [
                                {
                                    type: "vbox",
                                    padding: 0,
                                    children: [{ type: "checkbox", id: "txtFindCaseChk", isChanged: !1, label: f.matchCase }, { type: "checkbox", id: "txtFindWordChk", isChanged: !1, label: f.matchWord }, { type: "checkbox", id: "txtFindCyclic", isChanged: !1, "default": !0, label: f.matchCyclic }]
                                }
                                ]
                            }
                        ]
                                ...
                                children: [
                                    {
                                        ...
                                        onClick: function() {
                                            ...
                                            e.replaceCounter
                                                ? (alert(f.replaceSuccessMsg.replace(/%1/, e.replaceCounter)), c
                                                    .fire("saveSnapshot"))
                                                : alert(f.notFoundMsg)
                                        }
                                    }
                        ...
                        function(f) {
                            return function(e) {
                                ...
                                if (c) {
                                    ...
                                    for (k = 0; k < h; k++)
                                        i = this.getContentElement(u[e], p[k][e]), j = this
                                            .getContentElement(u[g], p[k][g]), j.setValue(i.getValue())
                                }
                            }
                        })
                },
                ...
                onHide: function() {
                    ...
                    e.matchRange &&
                        ...
                        (e.matchRange.removeHighlight(), c
                            .focus(), (a = e.matchRange.toDomRange()) && c.getSelection().selectRanges([a]));
                    delete e.matchRange
                },
                onFocus: function() {
                    return"replace" == g
