...
!function($) {
    ...
    DateRangePicker.prototype = {
        ...
        notify: function() {
            ...
            if (this.element.is("input")) {
                this.element.val(this.cleared
                    ? ""
                    : this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
            }
        ...
        updateCalendars: function() {
            ...
            this.rightCalendar.calendar = this
                .buildCalendar(this.rightCalendar.month.month(), this.rightCalendar.month.year(), "right");
