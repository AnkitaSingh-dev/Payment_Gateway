...
ColReorder = function(oDTSettings, oOpts) {
    ...
    oDTSettings.oApi
        ._fnCallbackReg(oDTSettings, "aoDestroyCallback", jQuery.proxy(this._fnDestroy, this), "ColReorder");
...
ColReorder.prototype = {
    ...
    "_fnOrderColumns": function(a) {
        if (a.length != this.s.dt.aoColumns.length) {
            this.s.dt.oInstance.oApi._fnLog(oDTSettings,
                1,
    ...
    "_fnMouseListener": function(i, nTh) {
        ...
        $(nTh)
            .bind("mousedown.ColReorder",
                function(e) {
                    that._fnMouseDown
                        .call(that, e, nTh, i); //Martin Marchetta: added the index of the column dragged or resized
                    return false;
                });
    },
    ...
    "_fnMouseDown": function(e, nTh, i) {
        ...
        $(document)
            .bind("mousemove.ColReorder",
                function(e) {
                    that._fnMouseMove
                        .call(that, e, i); //Martin Marchetta: Added index of the call being dragged or resized
                });

        $(document)
            .bind("mouseup.ColReorder",
                function(e) {
    ...
    "_fnMouseMove": function(e, colResized) {
        ...
        if (this.table_size < 0 &&
            ...
            if ($("div.dataTables_scrollHead", this.s.dt.nTableWrapper).length > 0)
                this.table_size = $($("div.dataTables_scrollHead", this.s.dt.nTableWrapper)[0].childNodes[0]
                        .childNodes[0])
                    .width();
        }
        ////////////////////
        ...
        if (this.dom.resize) {
            ...
            if (scrollXEnabled && $("div.dataTables_scrollHead", this.s.dt.nTableWrapper) != undefined) {
                if ($("div.dataTables_scrollHead", this.s.dt.nTableWrapper).length > 0)
                    $($("div.dataTables_scrollHead", this.s.dt.nTableWrapper)[0].childNodes[0].childNodes[0])
            ...
            if ($("div.dataTables_scrollBody") != null) {
                ...
                if ($("div.dataTables_scrollBody").length > 0) {
                    ...
                    $($(scrollingTableHead)[0].childNodes[visibleColumnIndex])
                        .width(this.s.mouse.startWidth + moveLength);
    ...
    "_fnMouseUp": function(e, colResized) {
        ...
        //Martin Marchetta
            ...
            if (!scrollXEnabled) {
                ...
                for (nextVisibleColumnIndex = colResized + 1;
                ...
                for (previousVisibleColumnIndex = colResized - 1;
                ...
                if (this.s.dt.aoColumns.length > nextVisibleColumnIndex)
                    this.s.dt.aoColumns[nextVisibleColumnIndex]
                        .sWidth = $(this.s.mouse.resizeElem).next().innerWidth() + "px";
    ...
    $.fn.dataTableExt.aoFeatures.push({
        "fnInit": function(oDTSettings) {
            ...
            if (typeof oTable._oPluginColReorder == "undefined") {
                var opts = typeof oDTSettings.oInit.oColReorder != "undefined" ? oDTSettings.oInit.oColReorder : {};
