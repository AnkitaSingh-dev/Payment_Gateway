...
(function() {
    ...
    function n(a, f) {
        var l = function(e) { return new CKEDITOR.dom.element(e, a.document) },
            n = a.editable(),
                ...
                if (b.info) {
                    ...
                    if (!this.hasColumnHeaders && ("col" == f || "both" == f))
                        for (j = 0; j < c.$.rows.length; j++)
                            g =
                                new CKEDITOR.dom.element(c.$.rows[j].cells[0]), g.renameNode("th"), g
                    ...
                    if (this
                        ...
                        for (i = 0;
                            ...
                            (g = new CKEDITOR.dom.element(j.$.cells[0]), g.renameNode("td"), g
                                    ...
                                    children: [
                                        {
                                            ...
                                            setup: function(e) { this.setValue(r(e)) },
                                            commit: k
                                        }, { type: "html", html: "&nbsp;" }, {
                                            type: "select",
                                            id: "selHeaders",
