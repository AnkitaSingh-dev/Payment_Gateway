...
(function() {
    ...
    function d(b) {
        ...
        c
            ...
            : a ? b.setAttribute(this.id, e[this.id][d]) : b.setAttribute(this.att || this.id, d)
    }
                                ...
                                children: [
                                    {
                                        ...
                                        validate: CKEDITOR.dialog.validate
                                            .htmlLength(a.invalidHtmlLength.replace("%1", a.width)),
                                        setup: c,
                                        commit: d
                                    }, {
                                        id: "height",
                                        ...
                                        label: a.height,
                                        validate: CKEDITOR.dialog.validate
                                            .htmlLength(a.invalidHtmlLength.replace("%1", a.height)),
                                        setup: c,
                                        commit: d
                                    }, {
                                        id: "align",
                                        ...
                                        "default": "",
                                        items: [
                                        [a.notSet, ""], [a.alignLeft, "left"], [a.alignRight, "right"],
